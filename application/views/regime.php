...
<div id="wrapper">
    ...
    <div class="container-lg" style="margin-top: 30px;width: 1000px;">
        ...
        <form action=#" method="post">
            ...
            <div class="mb-3 row">
                <label for="productname" class="col-sm-2 col-form-label">Aliment</label>
                <div class="col-sm-10">
                    <input class="form-check-input me-2" type="checkbox"  style="margin-left: 1px; margin-top:10px;" name="" id="" value=""><label class="form-check-label" for="flexCheckDefault" style="margin-left: 25px; margin-top:5px;">Riz</label><br>
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                <div class="col-sm-20">
                    <input type="submit" class="btn btn-primary btn-lg" value="Inserer">
                </div>
            </div>
        </form>  
    </div>
